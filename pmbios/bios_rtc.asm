...
;
%define NS_MS			00H			; milliseconds
%define NS_TSEC			01H			; hundredths/tenths of seconds
%define NS_SEC			02H			; seconds
%define NS_MIN			03H			; minutes
%define NS_HOUR			04H			; hour
%define NS_DOW			05H			; day of week
%define NS_DAY			06H			; day of month
%define NS_MONTH		07H			; month
%define NS_RAM			08H			; address offset for RAM registers
%define NS_RAM1			NS_RAM + NS_MS 	; 08H - RAM1 ms high nibble only, low = 0
%define NS_RAM2			NS_RAM + NS_TSEC	; 09H - RAM2 last month (Year DTK Hexa)
%define NS_RAM3			NS_RAM + NS_SEC	; 0AH - RAM3 year (AST)
%define NS_RAM4			NS_RAM + NS_MIN	; 0BH - RAM4 clock valid
%define NS_RAM5			NS_RAM + NS_HOUR	; 0CH - RAM5 not used
%define NS_RAM6			NS_RAM + NS_DOW	; 0DH - RAM6 week low nibble only, high = 0
%define NS_RAM7			NS_RAM + NS_DAY	; 0EH - RAM7 not used (Year 86Box)
%define NS_RAM8			NS_RAM + NS_MONTH	; 0FH - RAM8 not used
%define NS_TIME_RST		12H			; counter reset
%define NS_RAM_RST		13H			; RAM reset
%define NS_STATUS		14H			; rollover status bit

%define NS_RST			0FFH			; send all -1 to reset TIME and RAM
%define NS_STATE_OK		222			; Clock valid flag for NS_RAM4 (0BH)
%define NS_TEST			0AAH			; test value used for detection

;----------------------------------------------------------------------------;
; Standard RAM register addresses
;
%define NS_MONTH2		NS_RAM2		; 09H RAM - last month storage
%define NS_YEAR		    NS_RAM3		; 0AH RAM - year storage
%define NS_STATE		NS_RAM4		; 0BH clock valid flag (222 = valid)

;----------------------------------------------------------------------------;
; Config Defaults
;----------------------------------------------------------------------------;
%define READ_RETRY		10		; times to retry for rollover bit on reads
%define RST_STATE		1		; reset clock if no valid state flag
%define Y2K_OFFSET		1		; store as year-80 (00=1980, 20=2000, etc)
%define YEAR_BCD		0		; 1=store year as BCD, 0=byte
%define YEAR_INCR		1		; increment year (normal)
...
INT_1A_NS_RET:
	POP	DI
	POP	BX
	JMP	NEAR PTR IRET_CF_1		; IRET with current CF
